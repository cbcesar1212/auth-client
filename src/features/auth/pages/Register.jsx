    ...
    <div className="container bg-register">
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" name="paternal_lastname" value={formData.paternal_lastname} onChange={handleChange} required />
          <label>Apellido Materno</label>
          <input type="text" name="maternal_lastname" value={formData.maternal_lastname} onChange={handleChange} required />
          <label>Email</label>
